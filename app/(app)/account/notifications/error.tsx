...
export default function NotificationPreferencesError({
  ...
  useEffect(() => {
    log.error("notifications.preferences.route.boundary", {
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl px-4 py-12">
      <ErrorState
        title={t("notifications.preferences.loadError.title")}
        description={t("notifications.preferences.loadError.body")}
        correlationId={correlationId}
        correlationIdLabel={t("notifications.preferences.loadError.correlationLabel")}
